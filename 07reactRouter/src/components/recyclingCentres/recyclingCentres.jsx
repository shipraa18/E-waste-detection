...
//   ],
//   "Mumbai": [
//     { name: "E-Waste Management Inc.", address: "Dadar", id: 3 },
//     { name: "Green Earth Solutions", address: "Andheri", id: 4 },
//   ],
//   "Mysore": [
//     { name: "E-Waste Hub", address: "Mysore Palace Road", id: 5 },
//     { name: "Recycle Point", address: "KRS Road", id: 6 },
//   ],
//   "Chennai": [
//     { name: "Chi Recycle Hub", address: "202 Eco Park, Chennai", id: 7 },
//     { name: "Windy City E-Waste", address: "303 Green Cir, Chennai", id: 8 },
//   ],
//   // Add other cities with their respective recycling centers here
// };
...
//             <li
//               key={location}
//               onClick={() => setSearchTerm(location)} // Selecting a location from the dropdown
//               className="px-4 py-2 cursor-pointer hover:bg-gray-100"
//             >
//               {location}
//             </li>
...
import React, { useState } from "react";
import { useNavigate } from "react-router-dom";
import { FaMapMarkerAlt } from "react-icons/fa"; // Importing an icon for address
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {recyclingCenters.map((center) => (
              ...
              >
                {/* Image for the recycling center */}
                <img
                  src={center.image}
                  alt={center.name}
